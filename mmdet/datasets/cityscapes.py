    ...
    def evaluate(self,
        ...
        Args:
            ...
            outfile_prefix (str | None): The prefix of output file. It includes
                ...
                prefix of output json file. For example, the evaluation_metrics is 'bbox'
        ...
        Returns:
            dict[str, float]: COCO style evaluation evaluation_metrics or cityscapes mAP \
                and AP@50.
        """
        eval_results = dict()
        ...
        # left metrics are all coco evaluation_metrics
        if len(metrics) > 0:
