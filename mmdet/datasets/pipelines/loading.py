...
class LoadAnnotations:
    ...
    def _load_periodicity(self, results):
        """Private function to load binary periodicity annotations.
        ...
        results['gt_periodicity'] = results['ann_info']['periodicity'].copy()
        return results

    def _load_periods(self, results):
        """Private function to load binary period annotations.
        ...
        results['gt_periods'] = results['ann_info']['periods'].copy()
        # print('resultsgt_periods:', results['gt_periods'])
        return results
    ...
    def __call__(self, results):
        ...
        if self.with_period:
            results = self._load_periods(results)
            results = self._load_periodicity(results)
        if self.with_mask:
