...
class InstCount(QueryInst):
    r"""
    Implementation of InstCount
    Modifed from
    ...
    def forward_train(self,
        ...
        gt_bboxes = [_ for clip in gt_bboxes for _ in
                     clip]  # Some frames have multiple instances, then there will be multiple gt boxes
        gt_labels = [_ for clip in gt_labels for _ in clip]
        gt_periods = [_ for clip in gt_periods for _ in clip]
        gt_periodicity = [_ for clip in gt_periodicity for _ in clip]
